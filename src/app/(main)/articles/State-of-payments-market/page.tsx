    ...
    <div className="bg-white px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <p className="mt-6 text-xl leading-8">
          The payments industr 2022 performance, in terms of revenues and
          valuations, shows ongoing change with opportunities for growth and
          margin improvement across geographies and products. A close look at
          revenues uncovers some structural changes, including new developments
          in instant payments and digital wallets. Also, recent public company
          returns suggest investors may be regaining confidence following the
          volatility of 2020 - 22.
        </p>
